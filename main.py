    ...
    Search Cli Nzlgy1
    =================
    Productivity CLI tool that automates the task of monitoring common file operations.
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Productivity CLI tool that automates the task of monitoring common file operations.")
